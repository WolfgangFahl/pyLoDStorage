...
| **Cite** | [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17805335.svg)](https://doi.org/10.5281/zenodo.17805335) |

## Cite as

If you use pyLoDStorage in your research, please cite it via its Zenodo concept DOI
(which always resolves to the latest version):

> Fahl, W., & Holzheim, T.
> *pyLoDStorage — python List of Dict (Table) Storage library.*
> Zenodo. https://doi.org/10.5281/zenodo.17805335
...
[Zenodo record](https://doi.org/10.5281/zenodo.17805335).
